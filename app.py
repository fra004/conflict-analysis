...
def ask_article_cohere(question):
    ...
    prompt=prompt,
    max_tokens=200,
    model="command",  # Supports text generation
    temperature=0.5
)
...
def ask_article_cohere2(question, num_generations=1):
    ...
    co = cohere.Client("Fqr8mec0eNR0vMve2jXAbVDVAws8oK1EL7IY5CK5")
...
def get_response():
    ...
    response = ask_article_cohere(query)
